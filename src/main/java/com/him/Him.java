...
public class Him implements ModInitializer
{
	...
	public static final EntityType<HerobrineEntity> HEROBRINE = Registry.register(Registries.ENTITY_TYPE, new Identifier("him", "herobrine"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, HerobrineEntity::new).dimensions(EntityDimensions.fixed(0.6F, 1.95F)).build());
